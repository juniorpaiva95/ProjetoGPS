                        ...
                        <div class="tab-pane fade" id="delivery">
                            <form class="form-horizontal" role="form">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="zip" class="col-sm-2 control-label required">Zip Code</label>
                                        <div class="col-sm-10">
                        ...
                        <div class="tab-pane fade" id="checkout">
                            ...
                            <form role="form">
                                ...
                                <div class="col-md-6">
                                    <div class="credit-cart">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control cc_masking" id="CCnumber" placeholder="0000-0000-0000-0000" maxlength="19" autocomplete="off">
                                ...
                                <div class="shopping-validate">
                                    <a class="btn btn-success"><i class="fa fa-check p-r-10"></i>VALIDATE</a>
                                </div>
                            </form>
